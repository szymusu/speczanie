...
\begin{document}
	...
	\paragraph{}
	CSV (\textit{Comma-Separated Values}) jest luźnym formatem tekstowym przeznaczonym do tabelarycznych danych. Składa się z opcjonalnego nagłówka, oraz wierszy oddzielonych CRLF. W każdym wierszu znajduje się identyczna ilość pól oddzielonych separatorem (zazwyczaj \verb|,| lub \verb|;|). Plik taki można zaimportować jako tabelę we wielu aplikacjach do obsługi danych np. arkusz kalkulacyjny.
	\paragraph{}
	W naszym przypadku pierszy wiersz zawiera metadane wykresu, drugi zawiera nazwy kolumn, a każdy kolejny współrzędne jednego punktu.
	...
	\subsubsection{Aktywacja}
	\paragraph{}
	Moduł regresji aktywuje się przyciskiem \textit{Regresja}.
	...
	\section{Optymalizacja wydajności aplikacji - algorytm regresji wielomianowej}
	\subsection{Wstęp}
	...
	\subsubsection{Wykres po wczytaniu}
	\begin{figure}[H]
		\includegraphics[width=.8\textwidth, center]{images/proby/19_v10-1.png}
		\caption{Wykres próbki 1 po zaimportowaniu}
	\end{figure}
	
	\subsubsection{Obróbka wykresu}
	\begin{figure}[H]
		\includegraphics[width=.8\textwidth, center]{images/proby/19_v10-2.png}
	...
	\subsubsection{Wykres po wczytaniu}
	\begin{figure}[H]
		\includegraphics[width=.8\textwidth, center]{images/proby/20_v50-1.png}
		\caption{Wykres próbki 2 po zaimportowaniu}
	\end{figure}
	
	\subsubsection{Obróbka wykresu}
	\begin{figure}[H]
		\includegraphics[width=.8\textwidth, center]{images/proby/20_v50-2.png}
		\caption{Wykres próbki 2 przy ekstrapolacji}
	\end{figure}
	
	\subsection{Zestawienie wykresów $\sigma = f(\epsilon)$}
	\begin{figure}[H]
		\includegraphics[width=.8\textwidth, center]{images/proby/BA1032.png}
	...
	\subsubsection{Wykres po wczytaniu}
	\begin{figure}[H]
		\includegraphics[width=.8\textwidth, center]{images/proby/Totocz_v0p1-1.png}
		\caption{Wykres próbki 1 po zaimportowaniu}
	\end{figure}
	
	\subsubsection{Obróbka wykresu}
	\begin{figure}[H]
		\includegraphics[width=.8\textwidth, center]{images/proby/Totocz_v0p1-2.png}
		\caption{Wykres próbki 1 przy ekstrapolacji}
	\end{figure}
	...
	\subsubsection{Wykres po wczytaniu}
	\begin{figure}[H]
		\includegraphics[width=.8\textwidth, center]{images/proby/Totocz_v10-1.png}
		\caption{Wykres próbki 2 po zaimportowaniu}
	\end{figure}
	
	\subsubsection{Obróbka wykresu}
	\begin{figure}[H]
		\includegraphics[width=.8\textwidth, center]{images/proby/Totocz_v10-2.png}
		\caption{Wykres próbki 2 przy ekstrapolacji}
	\end{figure}
	...
	\subsubsection{Wykres po wczytaniu}
	\begin{figure}[H]
		\includegraphics[width=.8\textwidth, center]{images/proby/Totocz_v50-1.png}
		\caption{Wykres próbki 3 po zaimportowaniu}
	\end{figure}
	
	\subsubsection{Obróbka wykresu}
	\begin{figure}[H]
		\includegraphics[width=.8\textwidth, center]{images/proby/Totocz_v50-2.png}
		\caption{Wykres próbki 3 przy ekstrapolacji}
	\end{figure}
	
	\subsection{Zestawienie wykresów $\sigma = f(\epsilon)$}
	\begin{figure}[H]
		\includegraphics[width=.8\textwidth, center]{images/proby/Totocz-2.png}
	...
	\subsubsection{Wykres po wczytaniu}
	\begin{figure}[H]
		\includegraphics[width=.8\textwidth, center]{images/proby/T880-1.png}
		\caption{Wykres próbki 1 po zaimportowaniu}
	\end{figure}
	
	\subsubsection{Obróbka wykresu}
	\begin{figure}[H]
		\includegraphics[width=.8\textwidth, center]{images/proby/T880-2.png}
		\caption{Wykres próbki 1 przy ekstrapolacji}
	\end{figure}
	...
	\subsubsection{Wykres po wczytaniu}
	\begin{figure}[H]
		\includegraphics[width=.8\textwidth, center]{images/proby/T960-1.png}
		\caption{Wykres próbki 2 po zaimportowaniu}
	\end{figure}
	
	\subsubsection{Obróbka wykresu}
	\begin{figure}[H]
		\includegraphics[width=.8\textwidth, center]{images/proby/T960-2.png}
		\caption{Wykres próbki 2 przy ekstrapolacji}
	\end{figure}
	...
	\subsubsection{Wykres po wczytaniu}
	\begin{figure}[H]
		\includegraphics[width=.8\textwidth, center]{images/proby/T1000-1.png}
		\caption{Wykres próbki 3 po zaimportowaniu}
	\end{figure}
	
	\subsubsection{Obróbka wykresu}
	\begin{figure}[H]
		\includegraphics[width=.8\textwidth, center]{images/proby/T1000-2.png}
		\caption{Wykres próbki 3 przy ekstrapolacji}
	\end{figure}
	
	\subsection{Zestawienie wykresów $\sigma = f(\epsilon)$}
	\begin{figure}[H]
		\includegraphics[width=.8\textwidth, center]{images/proby/Tixo-2.png}
		\caption{Wykres naprężenie-odkształcenie próbek 1, 2 i 3}
	\end{figure}
